...
// const imageFile = require("./download.jpg");
const fs = require("fs");
const path = require("path");
// const strtoken= require("strtok3")


const imageFile = path.join(__dirname, "./data/jpeg.jpg")
// const Buff= Buffer.from(imageFile,"base64");
// console.log({Buff})
...
fs.readFile(imageFile, (err, data) => {
    ...
    console.log(check([0xFF, 0xD8, 0xFF]))
    ...
    const value = checkFileValidation()
    console.log({ value })
    // console.log({ check1 })
})
